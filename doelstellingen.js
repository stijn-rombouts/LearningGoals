const doelstellingen = {
  ...
  "9 Infrastructure": {
    ...
    "9.26 The student installs/configures/manages various server types in an (inter)network environment.": {
      ...
      "project": "Datacenter stuff",
      "subject": "Linux Network Services - Fase 2",
      "bewijs": "<div class='space-y-6'><p>In deze doelstellingµ heb ik diverse servers geconfigureerd en beheerd in een datacenter omgeving.</p><div class='accordion-item border rounded-lg overflow-hidden'><div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'><div class='flex items-center gap-3'><div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div><span class='font-semibold'>Proxmox Virtual Environment Cluster</span></div><svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path></svg></div><div class='toggle hidden p-4 border-t bg-white'><p>Ik heb een 3-node Proxmox cluster opgezet (pve01, pve02, pve03).</p>assets/9-26-pve.png</div><div class='line hidden h-1 bg-blue-600'></div></div><div class='accordion-item border rounded-lg overflow-hidden'><div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'><div class='flex items-center gap-3'><div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div><span class='font-semibold'>Rancher & RKE2 Kubernetes</span></div><svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path></svg></div><div class='toggle hidden p-4 border-t bg-white'><p>Bovenop het Proxmox cluster draait een RKE2 Kubernetes cluster, beheerd via Rancher. Dit cluster bestaat uit 3 control-plane nodes en 3 worker nodes.</p>assets/9-26-rancher.png</div><div class='line hidden h-1 bg-blue-600'></div></div><div class='accordion-item border rounded-lg overflow-hidden'><div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'><div class='flex items-center gap-3'><div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div><span class='font-semibold'>TrueNAS Storage & Replication</span></div><svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path></svg></div><div class='toggle hidden p-4 border-t bg-white'><p>Voor centrale opslag gebruik ik TrueNAS SCALE. Ik heb een tweede TrueNAS server opgezet voor back-ups, met actieve replicatie tussen beide nodes.</p><div class='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>assets/9-26-truenas.png assets/9-26-truenas-backup.png</div><p class='mt-4'>Op de <b>Data Protection</b> tab zijn de replicatie taken zichtbaar, evenals een <b>Cloud Sync</b> taak naar <b>Cloudflare R2</b> voor een off-site back-up van het Vaultwarden dataset.</p>assets/9-26-truenas-4.png<p class='mt-4'>Ook heb ik S3 storage geconfigureerd met <b>rustfs</b> op de TrueNAS server.</p>assets/9-26-truenas-backup-2.png</div><div class='line hidden h-1 bg-blue-600'></div></div><div class='accordion-item border rounded-lg overflow-hidden'><div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'><div class='flex items-center gap-3'><div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div><span class='font-semibold'>Proxmox Backup Server (PBS)</span></div><svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path></svg></div><div class='toggle hidden p-4 border-t bg-white'><p>Voor de back-up van alle virtuele machines en containers gebruik ik een dedicated Proxmox Backup Server, die gekoppeld is aan het cluster.</p>assets/9-26-pbs.png</div><div class='line hidden h-1 bg-blue-600'></div></div><div class='accordion-item border rounded-lg overflow-hidden'><div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'><div class='flex items-center gap-3'><div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div><span class='font-semibold'>Networking & SSL</span></div><svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path></svg></div><div class='toggle hidden p-4 border-t bg-white'><p>Alle services zijn beveiligd met HTTPS via Let's Encrypt certificaten. Hiervoor gebruik ik Cloudflare DNS challenges en DNS overrides in de pfSense router zodat lokale hostnames correct resolven naar interne IP's met geldige certificaten.</p>assets/9-26-pfsense.png</div><div class='line hidden h-1 bg-blue-600'></div></div></div>"
    },
