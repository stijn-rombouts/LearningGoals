const doelstellingen = {
  ...
  "2 Artificial Intelligens": {
    "2.1 You master the secret language of data and use the right jargon to explain Data Engineering concepts with precision.": {
      "type": [
        "AI"
      ],
      "status": "",
  ...
  "5 Soft skills": {
    "5.1 You make an ethical analysis in an IT context, weighing interests and balancing values and norms prevailing in society": {
      "type": [
        "CCS"
      ],
      "status": "d",
  ...
  "6 Cloud": {
    "6.1 You compare different types of virtualization, explain the benefits, and clarify the key differences between virtualization and emulation.": {
      "type": [
        "CCS"
      ],
      "status": "d",
  ...
  "7 Data": {
    "7.1 You analyze available data, uncover hidden formats and data types, and detect dirty data.": {
      "type": [
        "AI"
      ],
      "status": "",
  ...
  "8 Devops": {
    "8.1 You implement and manage container orchestration systems.": {
      "type": [
        "CCS"
      ],
      "status": "d",
          ...
          <div class='space-y-6'>
            <section>
              ...
              <p class='text-gray-700 leading-relaxed'>
                Opzetten van K3S cluster op orange PIs
              </p>
            </section>
            ...
            <section>
              ...
              <ul class='list-disc ml-5 text-gray-700 space-y-1'>
                <li>K3S cluster geconfigureerd op OrangePi hardware.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-004-OrangePI-Kubernetes-Cluster/blob/main/code/LearningGoals/8-1.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  ...
                  GitHub: Learning Goal 8.1 Documentation
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-004-OrangePI-Kubernetes-Cluster/blob/main/code/LearningGoals/8-2.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  <svg class='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z'/>
                  </svg>
                  GitHub: Learning Goal 8.2 Documentation
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-003-ip-terminals-netwerklokalen/blob/main/LearningGoals/8-3.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  <svg class='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z'/>
                  </svg>
                  GitHub: Learning Goal 8.3 Documentation
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-004-OrangePI-Kubernetes-Cluster/blob/main/code/LearningGoals/8-4.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  <svg class='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z'/>
                  </svg>
                  GitHub: Learning Goal 8.4 Documentation
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-004-OrangePI-Kubernetes-Cluster/blob/main/code/LearningGoals/8-5.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  <svg class='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z'/>
                  </svg>
                  GitHub: Learning Goal 8.5 Documentation
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-004-OrangePI-Kubernetes-Cluster/blob/main/code/LearningGoals/8-6.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  <svg class='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z'/>
                  </svg>
                  GitHub: Learning Goal 8.6 Documentation
                </a>
              </div>
            </section>
          </div>
  ...
  "9 Infrastructure": {
    "9.1 You install and configure a Windows Server Active Directory environment adapted to the characteristics and requirements of an SME (SBE small business enterprise)": {
      "type": [
        "CCS"
      ],
      "status": "d",
    ...
    "9.24 The student installs/configures/manages Linux network services found in an (inter)network environment.": {
      ...
      "bewijs": `<div class='space-y-6'>
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Projectbeschrijving</h3>
              <p class='text-gray-700 leading-relaxed'>
                Beheer en documentatie van de Digital Innovation datacenter infrastructuur. 
                Dit omvat het <strong>DI Hosting</strong> project voor RKE2 Kubernetes clusters en het <strong>DI4D</strong> project voor S3 storage oplossingen.
              </p>
            </section>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Behaalde resultaten</h3>
              <ul class='list-disc ml-5 text-gray-700 space-y-1'>
                <li>Implementatie van een 3-node Proxmox VE Cluster.</li>
                <li>Opzetten van een managed RKE2 Kubernetes cluster via Rancher.</li>
                <li>Configuratie van TrueNAS SCALE met S3 (rustfs).</li>
                <li>Configuratie van TrueNAS SCALE met off-site backup replicatie naar Cloudflare R2.</li>
                <li>Inrichten van een centrale Proxmox Backup Server (PBS).</li>
                <li>Automatisatie van SSL-certificaatbeheer via Cloudflare DNS challenges, Let's Encrypt ACME en pfSense DNS overrides.</li>
              </ul>
            </section>

            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie datacenter</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2425-Documentation-servers-in-datacenter/' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  ...
                  GitHub: Documentation servers in datacenter
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='border-t pt-6'>
          <p class='text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4'>Gedetailleerde technische details</p>
          <div class='space-y-4'>
            <div class='accordion-item border rounded-lg overflow-hidden'>
              <div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'>
                <div class='flex items-center gap-3'>
                  ...
                  <span class='font-semibold'>Proxmox Virtual Environment Cluster</span>
                </div>
              ...
              <div class='toggle hidden p-4 border-t bg-white'>
                <p>Ik heb een 3-node Proxmox cluster opgezet (pve01, pve02, pve03).</p>
                assets/9-26-pve.png
              </div>
            ...
            <div class='accordion-item border rounded-lg overflow-hidden'>
              <div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'>
                <div class='flex items-center gap-3'>
                  <div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div>
                  <span class='font-semibold'>Rancher & RKE2 Kubernetes</span>
                </div>
                <svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path>
                </svg>
              ...
              <div class='toggle hidden p-4 border-t bg-white'>
                <p>Bovenop het Proxmox cluster draait een RKE2 Kubernetes cluster, beheerd via Rancher. Dit cluster bestaat uit 3 control-plane nodes en 3 worker nodes.</p>
                assets/9-26-rancher.png
              </div>
              <div class='line hidden h-1 bg-blue-600'></div>
            </div>
            ...
            <div class='accordion-item border rounded-lg overflow-hidden'>
              <div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'>
                <div class='flex items-center gap-3'>
                  <div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div>
                  <span class='font-semibold'>TrueNAS Storage & Replication</span>
                </div>
                <svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path>
                </svg>
              ...
              <div class='toggle hidden p-4 border-t bg-white'>
                <p>Voor centrale opslag gebruik ik TrueNAS SCALE. Ik heb een tweede TrueNAS server opgezet voor back-ups, met actieve replicatie tussen beide nodes.</p>
                <div class='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>
                  assets/9-26-truenas.png 
                  assets/9-26-truenas-backup.png
                </div>
                <p class='mt-4'>Op de <b>Data Protection</b> tab zijn de replicatie taken zichtbaar, evenals een <b>Cloud Sync</b> taak naar <b>Cloudflare R2</b> voor een off-site back-up van het Vaultwarden dataset.</p>
                assets/9-26-truenas-4.png
                <p class='mt-4'>Ook heb ik S3 storage geconfigureerd met <b>rustfs</b> op de TrueNAS server.</p>
                assets/9-26-truenas-backup-2.png
              </div>
              <div class='line hidden h-1 bg-blue-600'></div>
            </div>
            ...
            <div class='accordion-item border rounded-lg overflow-hidden'>
              <div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'>
                <div class='flex items-center gap-3'>
                  <div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div>
                  <span class='font-semibold'>Proxmox Backup Server (PBS)</span>
                </div>
                <svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path>
                </svg>
              ...
              <div class='toggle hidden p-4 border-t bg-white'>
                <p>Voor de back-up van alle virtuele machines en containers gebruik ik een dedicated Proxmox Backup Server, die gekoppeld is aan het cluster.</p>
                assets/9-26-pbs.png
              </div>
              <div class='line hidden h-1 bg-blue-600'></div>
            </div>
            ...
            <div class='accordion-item border rounded-lg overflow-hidden'>
              <div class='header flex justify-between items-center p-4 bg-gray-50 cursor-pointer hover:bg-blue-50 transition-colors'>
                <div class='flex items-center gap-3'>
                  <div class='circle w-3 h-3 rounded-full border-2 border-gray-400'></div>
                  <span class='font-semibold'>Networking & SSL</span>
                </div>
                <svg class='w-5 h-5 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M19 9l-7 7-7-7'></path>
                </svg>
              ...
              <div class='toggle hidden p-4 border-t bg-white'>
                <p>Alle services zijn beveiligd met HTTPS via Let's Encrypt certificaten. Hiervoor gebruik ik Cloudflare DNS challenges en DNS overrides in de pfSense router zodat lokale hostnames correct resolven naar interne IP's met geldige certificaten.</p>
                assets/9-26-pfsense.png
              </div>
              <div class='line hidden h-1 bg-blue-600'></div>
            </div>
          </div>
    ...
    "9.27 The student works effectively with an automation configuration management tool.": {
      "type": [
        "CCS"
      ],
      "status": "d",
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Documentatie</h3>
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2526-ITF-004-OrangePI-Kubernetes-Cluster/blob/main/code/LearningGoals/9-27.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  <svg class='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z'/>
                  </svg>
                  GitHub: Learning Goal 9.27 Documentation
                </a>
              </div>
            </section>
          </div>
        ...
        <div class='bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm'>
          ...
          <div class='space-y-6'>
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Projectbeschrijving</h3>
              <p class='text-gray-700 leading-relaxed'>
                Voor de infrastructuur van het Digital Innovation datacenter was er nood aan een veilige en gebruiksvriendelijke manier voor studenten en docenten om vanop afstand toegang te krijgen tot interne services. 
              </p>
              <p class='text-gray-700 leading-relaxed'>
                Dit project omvatte de implementatie van een VPN-oplossing die voldoet aan de CIANA-principes en tevens een site-to-site verbinding mogelijk maakt met lokaal D202.
              </p>
            </section>
            ...
            <section>
              <h3 class='font-bold text-gray-800 mb-2'>Behaalde resultaten</h3>
              <ul class='list-disc ml-5 text-gray-700 space-y-1'>
                <li>Succesvolle uitrol van WG-Easy (WireGuard) in een Docker omgeving op Proxmox.</li>
                <li>Eenvoudig beheer van VPN-profielen voor gebruikers via een web-interface.</li>
                <li>Documentatie van de oplossing met focus op de CIANA-principes.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div class='flex flex-wrap gap-3'>
                <a href='https://github.com/Thomas-More-Digital-Innovation/2425-Documentation-servers-in-datacenter/blob/main/Documentation-VPN.md' target='_blank' class='inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors gap-2 text-sm font-medium'>
                  ...
                  GitHub: Documentatie WG-Easy VPN
                </a>
              </div>
            </section>
          </div>
